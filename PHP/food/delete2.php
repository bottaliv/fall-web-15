  ...
  <body>
    <div class="container">
        ...
        <div class="page-header">
          <h1>Exercise Log <small>Delete an Activity</small></h1>
        </div>
        <form class="form-horizontal" action="" method="post" >
          <div class='alert alert-danger alert-block'  id="myAlert">
            ...
            <h3>Are you sure you want to delete <?=$activity['Name']?></h3>
