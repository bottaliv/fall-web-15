  ...
  <body>
    <div class="container">
        ...
        <div class="page-header">
          <h1>Exercise <small>Record your daily Activity</small></h1>
        </div>
        ...
        <form class="form-horizontal" action="" method="post" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="txtName" name="Name" placeholder="Type of Activity" value="<?=$activity['Name']?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="txtMinutes">Minutes</label>
            <div class="col-sm-10">
                  <input type="number" class="form-control" id="txtMinutes" name="minutes" placeholder="Length of Activity"  value="<?=$activity['minutes']?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="txtDate">When did you workout?</label>
            <div class="col-sm-10">
                  <input type="text" class="form-control date" id="txtDate" name="Time" placeholder="Date"  value="<?=$activity['Time']?>">
            </div>
          </div>
          <div class="form-group">
